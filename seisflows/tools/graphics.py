...
def plot_2d_image(x, z, data, cmap="viridis", zero_midpoint=False,
                  resX=1000, resZ=1000, max_interp_dist=None):
    from scipy.interpolate import griddata
    from scipy.spatial import cKDTree   # neu
    ...
    if max_interp_dist is not None:
        ...
        cavity_mask = dist.reshape(X.shape) > max_interp_dist
        V[cavity_mask] = np.nan   # NaN → imshow zeigt dort nichts
